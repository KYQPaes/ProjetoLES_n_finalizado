...
<%
    ...
    Cartao cartao = cartaodao.SelectSingleCartao(id);
    request.setAttribute("editCartao", cartao);
%>
        ...
        <div id="all">
            ...
            <div id="meio">
                <div class="meiomenor">
                    <center>
                        <div class="cadastro">
                            <form class="form" action="ControleEditCartao" method="POST">
                                <table class="tabela">
                                    <tr>
                                        <th colspan="2">
                                            <h2>Edicao de cartao</h2>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" id="cardnumber" value="${editCartao.numero}" name="NumCard"></input>
                                        </td>
                                        <td>
                                            <input type="text" id="cardname" value="${editCartao.nome}" name="NameCard"></input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" id="validade" value="${editCartao.validade}" name="validade"></input>
                                        </td>
                                        <td>
                                            <input type="password" id="cvv" value="${editCartao.cvv}" name="cvv"></input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" id="cpf" value="${editCartao.cpf}" name="cpf"></input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                ...
                                <input type="hidden" value="${editCartao.id}" name="id">
                            </form>
                        </div>
                    </center>
                </div>
