        ...
        <div id="all">
            ...
            <div id="meio">
                <div class="meiomenor">
                    <center>
                        <div class="cadastro">
                            <form class="form" action="ControleEndereco_compra" method="POST">
                                <table class="tabela">
                                    <tr>
                                        <th colspan="2">
                                            <h2>Cadastro de Enderecos</h2>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" id="p" name="pais"></input>
                                        </td>
                                        <td>
                                            <input type="text" id="tel" name="telefone"></input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="address" name="endereco"></input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" id="house_number" name="numeroCasa"></input> 
                                    </td>
                                    <td>
                                        <input type="text" id="addon_address" name="complemento"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                       <input type="text" id="district" name="bairro"></input>
                                    </td>
                                    <td>
                                        <input type="text" id="city" name="cidade"></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" id="state" name="estado"></input>
                                    </td>
                                    <td>
                                        <input type="text" id="nick" name="apelido"></input>
                                    </td>
                                </tr>
                                    <tr>
                                        <td colspan="2">
