    ...
    <div id="all">
        ...
        <div id="meio">
            <div class="meiomenor">
                <center>
                    <div class="cadastro">
                        <form class="form" action="ControleProduto" method="POST">
                        <table class="tabela">
                            <tr>
                                <th colspan="2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="status">Defina um Tipo de produto:</label>
                                            ...
                                            <select name="tipo" value="" id="status">
                            ...
                            <tr>
                                <td>
                                        ...
                                        <textarea id="w3review" name="desc" rows="4" cols="50">
                            ...
                            <tr>
                                <td>
                                       ...
                                       <input type="number" step=".01" name="preco" value=""/>
                                 
                                </td>
                                
                                <td>
                                    <input type="number" step=".01" name="quantidade" value=""/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="trenviar">
                                <input type="submit" value="Adicionar novo produto" class="apply"/>
                                </td>
                                <td>
